...
export class CoreConfigConstants {
    ...
    static siteurl = 'lms.2piuconsulting.net';
    static sitename = 'lms2piu';
    ...
    static notificoncolor = '#00a28f';
    static statusbarbg = false;
    static statusbarlighttext = false;
    static statusbarbgios = '#00a28f';
    static statusbarlighttextios = true;
    static statusbarbgandroid = '#00a28f';
    ...
    static compilationtime = 1619077114995;
    static lastcommit = '9d12047268994498ebb1c1f6b2f5a4d615504be3';
}
