...
import { CoreCoursesCourseOptionsMenuComponent } from '@core/courses/components/course-options-menu/course-options-menu';

/**
 * Generated class for the CourseProgressComponent component.
 *
...
export class CourseProgressComponent {
  @Input("course") course: any; // The course to render.
